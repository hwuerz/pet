...
bool ecc_test()
{
    ...
    if (fp2compare64((uint64_t*)((point_precomp_t*)T_fixed)[v*(1 << (w-1))-1]->xy,(uint64_t*)Q->xy)!=0 || fp2compare64((uint64_t*)((point_precomp_t*)T_fixed)[v*(1 << (w-1))-1]->yx,(uint64_t*)Q->yx)!=0) { passed=0; }
    ...
    for (n=0; n<TEST_LOOPS; n++)
    {
        ...
        fp2mul1271(AA->t2, (felm_t*)&curve4Q.d, AA->t2); 
...
bool ecc_run()
{
    ...
    printf("  Point doubling runs in ...                                       %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");
    ...
    printf("  Point addition runs in ...                                       %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");
    ...
    printf("  Psi mapping runs in ...                                          %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");
    ...
    printf("  Phi mapping runs in ...                                          %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");
    ...
    printf("  Scalar decomposition runs in ...                                 %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");
    }
    ...
    printf("  Scalar recoding runs in ...                                      %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");  
    }
#endif
    ...
    printf("  Precomputation runs in ...                                       %8lld cycles", cycles/BENCH_LOOPS);
    printf("\n");  
    ...
    printf("  Table lookup runs in ...                                         %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");  
    ...
    printf("  Scalar multiplication (without clearing cofactor) runs in ...    %8lld cycles", cycles/SHORT_BENCH_LOOPS);
    printf("\n"); 
    ...
    printf("  Scalar multiplication (including clearing cofactor) runs in ...  %8lld cycles", cycles/SHORT_BENCH_LOOPS);
    printf("\n"); 
    ...
    {
        cycles1 = cpucycles();
        modulo_order((digit_t*)scalar, (digit_t*)scalar, &curve4Q);
        modulo_order((digit_t*)scalar, (digit_t*)scalar, &curve4Q);
        modulo_order((digit_t*)scalar, (digit_t*)scalar, &curve4Q);
        modulo_order((digit_t*)scalar, (digit_t*)scalar, &curve4Q);
        modulo_order((digit_t*)scalar, (digit_t*)scalar, &curve4Q);
    ...
    printf("  Reduction modulo the order runs in ...                           %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n"); 
    ...
    {
        cycles1 = cpucycles();
        table_lookup_fixed_base((point_precomp_t*)T_fixed, T, 1, 0);
        table_lookup_fixed_base((point_precomp_t*)T_fixed, T, 2, (unsigned int)-1);
        table_lookup_fixed_base((point_precomp_t*)T_fixed, T, 1, 0);
        table_lookup_fixed_base((point_precomp_t*)T_fixed, T, 2, (unsigned int)-1);
        table_lookup_fixed_base((point_precomp_t*)T_fixed, T, 1, 0);
        table_lookup_fixed_base((point_precomp_t*)T_fixed, T, 2, (unsigned int)-1);
    ...
    printf("  Fixed-base table lookup runs in ...                              %8lld cycles", cycles/(BENCH_LOOPS*10));
    printf("\n");   
